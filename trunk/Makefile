...
TEMPLATE_FILES+= vector.h vector.cpp dataset.h dataset.cpp raw-types.h
...
$(SPEED): $(TEMPLATE_FILES) $(SPEED).cpp $(SPEED).ggo tool_utils.h Makefile
	@echo $(COMPILE_NOTIFY)
...
$(TEST): $(TEMPLATE_FILES) $(TEST).cpp $(TEST).ggo tool_utils.h Makefile
	@echo $(COMPILE_NOTIFY)
