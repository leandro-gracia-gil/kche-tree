...
#ifndef SPEED_KNN_ARGS_H
#define SPEED_KNN_ARGS_H
...
#define CMDLINE_PARSER_PACKAGE "Kche-tree library benchmark tool."
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "Kche-tree library benchmark tool."
#endif
...
struct speed_knn_args
{
  ...
  float tolerance_arg;	/**< @brief Tolerance value used when comparing the distance values to the exhaustive search version. (default='1e-3').  */
...
struct cmdline_parser_params
{
  ...
  int initialize; /**< @brief whether to initialize the option structure speed_knn_args (default 1) */
  int check_required; /**< @brief whether to check that all required options were provided (default 1) */
  int check_ambiguity; /**< @brief whether to check for options already specified in the option structure speed_knn_args (default 0) */
  int print_errors; /**< @brief whether getopt_long should print an error message for a bad option (default 1) */
} ;

/** @brief the purpose string of the program */
extern const char *speed_knn_args_purpose;
/** @brief the usage string of the program */
extern const char *speed_knn_args_usage;
/** @brief all the lines making the help output */
extern const char *speed_knn_args_help[];
...
int cmdline_parser (int argc, char **argv,
  struct speed_knn_args *args_info);
...
/**
 * Initializes the passed speed_knn_args structure's fields
 * (also set default values for options that have a default)
 * @param args_info the structure to initialize
 */
void cmdline_parser_init (struct speed_knn_args *args_info);
/**
 * Deallocates the string fields of the speed_knn_args structure
 * (but does not deallocate the structure itself)
 * @param args_info the structure to deallocate
 */
void cmdline_parser_free (struct speed_knn_args *args_info);
 ...
 * @return
 */
int cmdline_parser_required (struct speed_knn_args *args_info,
